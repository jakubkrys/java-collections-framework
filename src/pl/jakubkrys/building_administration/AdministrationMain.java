...
public class AdministrationMain {
    ...
    private static AdministrationRepository administrationRepository = new AdministrationRepository();
        ...
        do {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    administrationRepository.displayAll();
                    break;
                case 4:
                    editOfficeData();
                    break;
                case 5:
                    administrationRepository.remove(getOfficeByCompanyName());
                    break;
            }
        } while (option != 0);
    }
    ...
    private static void addNewOffice() {
        ...
        administrationRepository.add(office);
    }
    ...
    private static Office getOfficeByCompanyName() {
        ...
        return administrationRepository.getByCompanyName(companyName);
    }
